...
local function get_notify_icons()
    if not IsMac then
        return nonicons_extention.icons
    else
        return nil
    end
end
...
local function get_lualine_a()
    if not IsMac then
        return { nonicons_extention.mode }
    else
        return nil
    end
end
